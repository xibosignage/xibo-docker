...
echo replacing ___APPLICATION_IP___/$CMS-WEB_PORT_80_TCP_ADDR
echo replacing ___APPLICATION_PORT___/$CMS-WEB_PORT_80_TCP_PORT
...
sed -i "s/___APPLICATION_IP___/$CMS-WEB_PORT_80_TCP_ADDR/g" /etc/nginx/nginx.conf
sed -i "s/___APPLICATION_PORT___/$CMS-WEB_PORT_80_TCP_PORT/g" /etc/nginx/nginx.conf
...
# Add your app's container IP and port into config
sed -i "s/___APPLICATION_IP___/$CMS-WEB_PORT_80_TCP_ADDR/g" /etc/nginx/nginx-secure.conf
sed -i "s/___APPLICATION_PORT___/$CMS-WEB_PORT_80_TCP_PORT/g" /etc/nginx/nginx-secure.conf
